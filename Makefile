...
TEST_EXES := tests/test_reconstructCandidates.exe tests/test_probe_parallel.exe tests/test_record_writer.exe tests/test_rootAnalysis_smoke.exe tests/test_paint.exe tests/test_config.exe
